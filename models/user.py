...
class Users(TimestampMixin, db.Model, UserMixin):
    ...
    country_id = db.Column(db.String(24), nullable=False)
    country = db.Column(db.String(64), nullable=False)
    region_id = db.Column(db.String(24), nullable=True)
    region = db.Column(db.String(64), nullable=True)
    province_id = db.Column(db.String(24), nullable=True)
    province = db.Column(db.String(64), nullable=True)
    zip_code = db.Column(db.String(24), nullable=True)
    city_id = db.Column(db.String(24), nullable=True)
