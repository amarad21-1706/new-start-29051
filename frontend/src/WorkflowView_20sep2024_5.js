        ...
        <form onSubmit={handleSubmit} className="form-container">
          ...
          <div className="form-group">
            ...
            <select
                ...
                onChange={(e) => {
                  ...
                  setSelectedWorkflow(value === "" ? null : value); // Ensure we pass null if no workflow is selected
                }}
                className="form-control"
            >
          ...
          <div className="form-group">
            ...
            <select
                ...
                onChange={(e) => {
                  const value = e.target.value;
                  setSelectedStep(value === "" ? null : value); // Ensure we pass null if no step is selected
                }}
                className="form-control"
            >
