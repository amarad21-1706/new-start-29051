...
class Config:
    def __init__(self):
        ...
        '''
        # PostgreSQL
        self.SQLALCHEMY_DATABASE_URI = 'postgresql://aradulescu:brez-post-2024-24@localhost/silver_base'
        self.SQLALCHEMY_BINDS = {
            'db1': 'postgresql://aradulescu:brez-post-2024-24@localhost/silver_base'
        }
...
def get_pd_report_from_base_data_wtq222(session):
    # Get the records without the time qualifier
    print('db7')
    query = session.query(
        BaseData.company_id,
